...
@Autonomous(name = "Blue: Move Base to the Right and Park Wall", group = "Jan 12 Competition")
public class BaseMoverWallBlue extends LinearOpMode {
    private Robot robot;
